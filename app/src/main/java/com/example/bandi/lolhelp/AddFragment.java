...
public class AddFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mEditTextFirstrune = view.findViewById(R.id.firstrune_ed);
        mEditTextFirstsp1 = view.findViewById(R.id.firstsp1_ed);
        mEditTextFirstsp2 = view.findViewById(R.id.firstsp2_ed);
        mEditTextFirstsp3 = view.findViewById(R.id.firstsp3_ed);
        mEditTextFirstsp4 = view.findViewById(R.id.firstsp4_ed);
        mEditTextSecondrune = view.findViewById(R.id.secondrune_ed);
        mEditTextSecondsp1 =view.findViewById(R.id.secondsp1_ed);
        mEditTextSecondsp2 =view.findViewById(R.id.secondsp2_ed);
                ...
                public void onComplete(@NonNull Task<Uri> task)
                {
                    if (task.isSuccessful())
                    {
                        ...
                        Upload upload = new Upload(mEditTextFileName.getText().toString().trim(),
                                ...
                                mEditTextFirstrune.getText().toString(),mEditTextFirstsp1.getText().toString(),
                                mEditTextFirstsp2.getText().toString(),mEditTextFirstsp3.getText().toString(),
                                mEditTextFirstsp4.getText().toString(),mEditTextSecondrune.getText().toString(),
                                mEditTextSecondsp1.getText().toString(),mEditTextSecondsp2.getText().toString(),phonenumber);
